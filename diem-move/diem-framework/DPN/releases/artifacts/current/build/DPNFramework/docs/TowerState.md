...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_init_difficulty">init_difficulty</a>(vm: &signer) {
  ...
  <b>if</b> (!<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a>&gt;(@VMReserved )) {
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_init_miner_list">init_miner_list</a>(vm: &signer) {
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_diem_root">CoreAddresses::assert_diem_root</a>(vm);
  <b>move_to</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>&gt;(vm, <a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_init_tower_counter">init_tower_counter</a>(
  ...
  <b>if</b> (!<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(@VMReserved)) {
    <b>move_to</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(vm, <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a> {
      lifetime_proofs,
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_is_onboarding">is_onboarding</a>(addr: <b>address</b>): bool <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>let</b> count = <a href="TowerState.md#0x1_TowerState_get_count_in_epoch">get_count_in_epoch</a>(addr);
  <b>let</b> state = <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(addr);
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_increment_miners_list">increment_miners_list</a>(miner: <b>address</b>) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a> {
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>&gt;(@0x0)) {
    <b>let</b> state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>&gt;(@0x0);
    <b>if</b> (!<a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_contains">Vector::contains</a>&lt;<b>address</b>&gt;(&<b>mut</b> state.list, &miner)) {
      <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_push_back">Vector::push_back</a>&lt;<b>address</b>&gt;(&<b>mut</b> state.list, miner);
    }
  }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_genesis_helper">genesis_helper</a>(
  ...
  // In rust the vm_genesis creates a <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer">Signer</a> for the miner.
  // So the SENDER is not the same and the <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer">Signer</a>.
  ...
  <b>let</b> node_addr = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(miner_sig);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_commit_state">commit_state</a>(
  ...
  <b>let</b> miner_addr = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(miner_sign);
  // <b>let</b> diff = <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a>&gt;(@VMReserved );
  ...
  <b>if</b> (!<a href="TowerState.md#0x1_TowerState_is_init">is_init</a>(miner_addr)) {
    <b>assert</b>!(&proof.difficulty
      == &<a href="Globals.md#0x1_Globals_get_vdf_difficulty_baseline">Globals::get_vdf_difficulty_baseline</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_argument">Errors::invalid_argument</a>(130102));
    <b>assert</b>!(&proof.security
      == &<a href="Globals.md#0x1_Globals_get_vdf_security_baseline">Globals::get_vdf_security_baseline</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_argument">Errors::invalid_argument</a>(13010202));
    ...
    <b>assert</b>!(addr_in_proof == <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(miner_sign), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_requires_role">Errors::requires_role</a>(130112));

    <a href="TowerState.md#0x1_TowerState_init_miner_state">init_miner_state</a>(
      miner_sign, &proof.challenge, &proof.solution, proof.difficulty, proof.security
    );
    <b>return</b>
  };

  // // Skip this check on <b>local</b> tests, we need tests <b>to</b> send different difficulties.
  // <b>if</b> (!<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>()){
  ...
  //   } <b>else</b> {
  //     <b>assert</b>!(&proof.difficulty == &diff.difficulty, <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_argument">Errors::invalid_argument</a>(130102));
  //     <b>assert</b>!(&proof.security == &diff.security, <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_argument">Errors::invalid_argument</a>(13010202));
  //   };
  // };
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_commit_state_by_operator">commit_state_by_operator</a>(
  ...
  // Skip this check on <b>local</b> tests, we need tests <b>to</b> send differentdifficulties.
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_verify_and_update_state">verify_and_update_state</a>(
  ...
  <b>assert</b>!(
    ...
    <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130108)
  );

  <b>let</b> miner_history = <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr);
  ...
  <b>if</b> (steady_state) {
    ...
    <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130109));
  };

  <b>let</b> valid = <a href="VDF.md#0x1_VDF_verify">VDF::verify</a>(&proof.challenge, &proof.solution, &proof.difficulty, &proof.security);
  <b>assert</b>!(valid, <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_argument">Errors::invalid_argument</a>(130110));
  ...
  <b>let</b> miner_history = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr);

  // <b>update</b> the miner proof history (result is used <b>as</b> seed for next proof)
  miner_history.previous_proof_hash = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Hash.md#0x1_Hash_sha3_256">Hash::sha3_256</a>(*&proof.solution);
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_update_epoch_metrics_vals">update_epoch_metrics_vals</a>(account: &signer, miner_addr: <b>address</b>) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_node_above_thresh">node_above_thresh</a>(miner_addr: <b>address</b>): bool <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_epoch_param_reset">epoch_param_reset</a>(vm: &signer) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a>, <a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>, <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>  {
  ...
  <b>let</b> diff = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a>&gt;(@VMReserved );
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_reconfig">reconfig</a>(
  vm: &signer, outgoing_validators: &vector&lt;<b>address</b>&gt;
) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>, <a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>, <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>, <a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a> {
  // Check permissions
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_diem_root">CoreAddresses::assert_diem_root</a>(vm);
  ...
  <b>let</b> vals_len = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_length">Vector::length</a>&lt;<b>address</b>&gt;(outgoing_validators); // TODO: These references are weird
  <b>let</b> i = 0;
  <b>while</b> (i &lt; vals_len) {
      <b>let</b> val = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_borrow">Vector::borrow</a>(outgoing_validators, i);

      // For testing: don't call update_metrics unless there is account state for the <b>address</b>.
  ...
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>&gt;(@0x0)) {
    //reset miner list
    <b>let</b> towerlist_state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>&gt;(@0x0);
    towerlist_state.list = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_empty">Vector::empty</a>&lt;<b>address</b>&gt;();
  };
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_init_miner_state">init_miner_state</a>(
  ...
  // NOTE Only <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer">Signer</a> can <b>update</b> own state.
  // Should only happen once.
  <b>assert</b>!(!<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(<a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(miner_sig)), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_requires_role">Errors::requires_role</a>(130111));
  // <a href="DiemAccount.md#0x1_DiemAccount">DiemAccount</a> calls this.
  // Exception is <a href="DiemAccount.md#0x1_DiemAccount">DiemAccount</a> which can simulate a <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer">Signer</a>.
  ...
  <b>move_to</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_sig, <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>{
    previous_proof_hash: <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_empty">Vector::empty</a>(),
  ...
  //submit the proof
  <a href="TowerState.md#0x1_TowerState_verify_and_update_state">verify_and_update_state</a>(<a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(miner_sig), proof, <b>false</b>);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_first_challenge_includes_address">first_challenge_includes_address</a>(new_account_address: <b>address</b>, challenge: &vector&lt;u8&gt;) {
  // Checks that the preimage/challenge of the FIRST <a href="VDF.md#0x1_VDF">VDF</a> proof blob contains a given <b>address</b>.
  // This is <b>to</b> ensure that the same proof is not sent repeatedly, since all the minerstate is on a
  // the <b>address</b> of a miner.
  ...
  <b>assert</b>!(<a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Vector.md#0x1_Vector_length">Vector::length</a>(challenge) &gt;= 32, <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_argument">Errors::invalid_argument</a>(130113));
  ...
  // Confirm the <b>address</b> is corect and included in challenge
  <b>assert</b>!(new_account_address == parsed_address, <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_requires_address">Errors::requires_address</a>(130114));
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_miner_latest_epoch">get_miner_latest_epoch</a>(addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>let</b> addr_state = <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(addr);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_reset_rate_limit">reset_rate_limit</a>(miner: &signer) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>let</b> state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(<a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(miner));
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_increment_stats">increment_stats</a>(miner_addr: <b>address</b>) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>, <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a> {
  // safety. Don't cause VM <b>to</b> halt
  <b>if</b> (!<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(@VMReserved)) <b>return</b>;

  <b>let</b> above = <a href="TowerState.md#0x1_TowerState_node_above_thresh">node_above_thresh</a>(miner_addr);

  <b>let</b> state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(@VMReserved);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_miner_list">get_miner_list</a>(): vector&lt;<b>address</b>&gt; <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a> {
  <b>if</b> (!<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>&gt;(@0x0)) {
  ...
  *&<b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerList">TowerList</a>&gt;(@0x0).list
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_tower_height">get_tower_height</a>(node_addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(node_addr)) {
    <b>return</b> <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(node_addr).verified_tower_height
  };
  0
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_epochs_compliant">get_epochs_compliant</a>(node_addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(node_addr)) {
    <b>return</b> <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(node_addr).epochs_validating_and_mining
  };
  0
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_count_in_epoch">get_count_in_epoch</a>(miner_addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr)) {
    <b>let</b> s = <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_count_above_thresh_in_epoch">get_count_above_thresh_in_epoch</a>(miner_addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr)) {
    <b>if</b> (<b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr).count_proofs_in_epoch &gt; <a href="Globals.md#0x1_Globals_get_epoch_mining_thres_lower">Globals::get_epoch_mining_thres_lower</a>()) {
      <b>return</b> <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr).count_proofs_in_epoch - <a href="Globals.md#0x1_Globals_get_epoch_mining_thres_lower">Globals::get_epoch_mining_thres_lower</a>()
    }
  };
  0
}
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_lazy_reset_count_in_epoch">lazy_reset_count_in_epoch</a>(miner_addr: <b>address</b>) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>let</b> s = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr);
  <b>if</b> (s.latest_epoch_mining &lt; <a href="DiemConfig.md#0x1_DiemConfig_get_current_epoch">DiemConfig::get_current_epoch</a>()) {
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_can_create_val_account">can_create_val_account</a>(node_addr: <b>address</b>): bool <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  ...
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(node_addr)) {
    <b>return</b>
      <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(node_addr).epochs_since_last_account_creation
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_validator_proofs_in_epoch">get_validator_proofs_in_epoch</a>(): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>{
  <b>let</b> state = <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(@VMReserved);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_get_difficulty">get_difficulty</a>(): (u64, u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a> {
  <b>if</b> (<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a>&gt;(@VMReserved )) {
    <b>let</b> v = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a>&gt;(@VMReserved );
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_epoch_reset_counter">test_epoch_reset_counter</a>(vm: &signer) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130118));
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_vm">CoreAddresses::assert_vm</a>(vm);
  <b>let</b> state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(@VMReserved);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_operator_submits">test_helper_operator_submits</a>(
  operator_addr: <b>address</b>, // Testrunner does not allow arbitrary accounts
                          // <b>to</b> submit txs, need <b>to</b> <b>use</b> <b>address</b>, so this will
  ...
  <b>assert</b>!(
    ...
    <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_requires_address">Errors::requires_address</a>(130119)
  );
  // Abort <b>if</b> not initialized.
  <b>assert</b>!(<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_not_published">Errors::not_published</a>(130116));

  // Check vdf difficulty constant. Will be different in tests than in production.
  // Skip this check on <b>local</b> tests, we need tests <b>to</b> send different difficulties.
  <b>if</b> (!<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>()){ // todo: remove?
    <b>assert</b>!(&proof.difficulty
      == &<a href="Globals.md#0x1_Globals_get_vdf_difficulty_baseline">Globals::get_vdf_difficulty_baseline</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130117));
  };
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_mock_mining_vm">test_helper_mock_mining_vm</a>(vm: &signer, addr: <b>address</b>, count: u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>, <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130120));
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_diem_root">CoreAddresses::assert_diem_root</a>(vm);
  <a href="TowerState.md#0x1_TowerState_danger_mock_mining">danger_mock_mining</a>(addr, count)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="TowerState.md#0x1_TowerState_danger_mock_mining">danger_mock_mining</a>(addr: <b>address</b>, count: u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>, <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a> {
  // again for safety
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130118));
  ...
  <b>while</b> (i &lt; count) {
    ...
    <b>let</b> state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(addr);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_mock_reconfig">test_helper_mock_reconfig</a>(account: &signer, miner_addr: <b>address</b>) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>, <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a> {
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_diem_root">CoreAddresses::assert_diem_root</a>(account);
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130122));
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_get_height">test_helper_get_height</a>(miner_addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130123));
  <b>assert</b>!(<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_not_published">Errors::not_published</a>(130124));

  <b>let</b> state = <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_get_nominal_count">test_helper_get_nominal_count</a>(miner_addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130123));
  <b>assert</b>!(<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_not_published">Errors::not_published</a>(130124));
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_get_contiguous_vm">test_helper_get_contiguous_vm</a>(vm: &signer, miner_addr: <b>address</b>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_get_contiguous_vm">test_helper_get_contiguous_vm</a>(vm: &signer, miner_addr: <b>address</b>): u64 <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130125));
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_diem_root">CoreAddresses::assert_diem_root</a>(vm);
  <b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(miner_addr).contiguous_epochs_validating_and_mining
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_set_rate_limit">test_helper_set_rate_limit</a>(account: &signer, value: u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130126));
  <b>let</b> addr = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(account);
  <b>let</b> state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(addr);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_set_epochs_mining">test_helper_set_epochs_mining</a>(node_addr: <b>address</b>, value: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_set_epochs_mining">test_helper_set_epochs_mining</a>(node_addr: <b>address</b>, value: u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130126));

  <b>let</b> s = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(node_addr);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_set_proofs_in_epoch">test_helper_set_proofs_in_epoch</a>(node_addr: <b>address</b>, value: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_set_proofs_in_epoch">test_helper_set_proofs_in_epoch</a>(node_addr: <b>address</b>, value: u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130126));
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_previous_proof_hash">test_helper_previous_proof_hash</a>(
  ...
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130128));
  <b>let</b> addr = <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(account);
  *&<b>borrow_global</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(addr).previous_proof_hash
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_set_weight_vm">test_helper_set_weight_vm</a>(vm: &signer, addr: <b>address</b>, weight: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_helper_set_weight_vm">test_helper_set_weight_vm</a>(vm: &signer, addr: <b>address</b>, weight: u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130113));
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_diem_root">CoreAddresses::assert_diem_root</a>(vm);
  <b>let</b> state = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerProofHistory">TowerProofHistory</a>&gt;(addr);
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_mock_depr_tower_stats">test_mock_depr_tower_stats</a>(vm: &signer) {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130113));
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_vm">CoreAddresses::assert_vm</a>(vm);
  <b>move_to</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerStats">TowerStats</a>&gt;(vm, <a href="TowerState.md#0x1_TowerState_TowerStats">TowerStats</a>{
    proofs_in_epoch: 111,
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_set_vdf_difficulty">test_set_vdf_difficulty</a>(vm: &signer, diff: u64, sec: u64) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a> {
  ...
  <b>let</b> s = <b>borrow_global_mut</b>&lt;<a href="TowerState.md#0x1_TowerState_VDFDifficulty">VDFDifficulty</a>&gt;(@VMReserved );
  s.difficulty = diff;
  s.security = sec;
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TowerState.md#0x1_TowerState_test_danger_destroy_tower_counter">test_danger_destroy_tower_counter</a>(vm: &signer) <b>acquires</b> <a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a> {
  <b>assert</b>!(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130113));
  <a href="CoreAddresses.md#0x1_CoreAddresses_assert_vm">CoreAddresses::assert_vm</a>(vm);
  <b>assert</b>!(<b>exists</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(@VMReserved), <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(130115));

    // We destroy the data resource for sender
    // <b>move_from</b> and then destructure
   ...
   } = <b>move_from</b>&lt;<a href="TowerState.md#0x1_TowerState_TowerCounter">TowerCounter</a>&gt;(@VMReserved);
}
</code></pre>
